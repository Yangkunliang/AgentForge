...
- [x] TASK-048：Dashboard 多租户隔离，修复 Task 数量、费用和最近任务跨用户读取风险。
- [x] TASK-049：TaskGraph，把任务拆解产物升级为结构化、可依赖、可执行、可验收的任务图。
- [x] TASK-050：WorkspaceExecutor，在用户授权 ProjectMount 内生成、预览和应用文件级 Patch。
