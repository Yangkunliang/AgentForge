...
| 用户故事 | 产品目标 | 覆盖任务 |
|---|---|---|
| US-1 | 输入自然语言需求，系统自动拆解并分派给合适 Agent | [TASK-002](TASK-002.md)、[TASK-003](TASK-003.md)、[TASK-005](TASK-005.md)、[TASK-006](TASK-006.md)、[TASK-011](TASK-011.md) |
| US-2 | Agent 自动完成产品设计、UI 设计、任务拆解 | [TASK-002](TASK-002.md)、[TASK-003](TASK-003.md)、[TASK-005](TASK-005.md)、[TASK-006](TASK-006.md)、[TASK-011](TASK-011.md) |
...
| CDW-02 | 代码库上下文必须由用户主动授权，不自动扫描目录 | [TASK-012](TASK-012.md)、[TASK-013](TASK-013.md)、[TASK-014](TASK-014.md)、[TASK-018](TASK-018.md) |
